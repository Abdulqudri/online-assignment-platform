module.exports = (io) => {
  ...
  router.get("/submission/notifications", submissionNotifications);
  router.get("/review/notifications", reviewNotifications);
